; ModuleID = 'foo2-hip-amdgcn-amd-amdhsa-gfx942.bc'
source_filename = "foo2.cpp"
...
@__hip_cuid_f4491f24ee8f53ea = addrspace(1) global i8 0
@__oclc_ABI_version = weak_odr hidden local_unnamed_addr addrspace(4) constant i32 500
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_f4491f24ee8f53ea to ptr)], section "llvm.metadata"
...
define protected amdgpu_kernel void @_Z4foo2v() local_unnamed_addr #5 {
