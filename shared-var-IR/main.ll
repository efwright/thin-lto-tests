; ModuleID = 'main-hip-amdgcn-amd-amdhsa-gfx942.bc'
...
@gvar = protected addrspace(1) externally_initialized global i32 undef, align 4
@__clang_gpu_used_external = internal addrspace(1) global [2 x ptr] [ptr @_Z4foo1v, ptr @_Z4foo2v]
@__hip_cuid_d4dfcb9242c500a3 = addrspace(1) global i8 0
@__oclc_ABI_version = weak_odr hidden local_unnamed_addr addrspace(4) constant i32 500
@llvm.compiler.used = appending addrspace(1) global [3 x ptr] [ptr addrspacecast (ptr addrspace(1) @__clang_gpu_used_external to ptr), ptr addrspacecast (ptr addrspace(1) @__hip_cuid_d4dfcb9242c500a3 to ptr), ptr addrspacecast (ptr addrspace(1) @gvar to ptr)], section "llvm.metadata"
...
define weak hidden void @__assert_fail(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #2 {
  ...
  call void @llvm.lifetime.start.p5(i64 47, ptr addrspace(5) %5) #10
  ...
  %59 = tail call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
174:                                              ; preds = %172
  ...
  %177 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
.loopexit.i:                                      ; preds = %.preheader.i, %657, %655
  ...
  %710 = and i64 %311, -225
  %711 = or i64 %710, %709
  %712 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
829:                                              ; preds = %826
  ...
  %832 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
.loopexit.i54:                                    ; preds = %.preheader.i53, %1317, %1315
  ...
  %1373 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
__ockl_fprintf_append_string_n.exit69:            ; preds = %__ockl_hostcall_preview.exit20.i57, %__ockl_hostcall_preview.exit.i64
  ...
  %1488 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
1600:                                             ; preds = %1598
  ...
  %1603 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
.loopexit.i90:                                    ; preds = %.preheader.i89, %2088, %2086
  ...
  %2144 = call i32 asm sideeffect "", "=v,0"(i32 %58) #13, !srcloc !10
...
2258:                                             ; preds = %2255
  ...
  call fastcc void @__ockl_fprintf_append_string_n(i64 noundef %2259, ptr noundef %0, i64 noundef %2263, i32 noundef 1) #13
  call void @llvm.trap()
  unreachable
}
...
define protected amdgpu_kernel void @_Z4initv() local_unnamed_addr #5 {
  store i32 0, ptr addrspace(3) addrspacecast (ptr addrspace(1) @gvar to ptr addrspace(3)), align 4, !tbaa !34
  ret void
}

; Function Attrs: convergent nounwind
declare protected amdgpu_kernel void @_Z4foo1v() #6

; Function Attrs: convergent nounwind
declare protected amdgpu_kernel void @_Z4foo2v() #6
...
define internal fastcc void @__ockl_fprintf_append_string_n(i64 noundef %0, ptr noundef readonly %1, i64 noundef %2, i32 noundef %3) unnamed_addr #12 {
  %5 = icmp eq i32 %3, 0
  %6 = or i64 %0, 2
...
9:                                                ; preds = %4
  ...
  %18 = tail call i32 asm sideeffect "", "=v,0"(i32 %17) #13, !srcloc !10
...
.loopexit:                                        ; preds = %.preheader, %506, %504
  ...
  %560 = and i64 %154, -225
  %561 = or i64 %560, %559
  %562 = tail call i32 asm sideeffect "", "=v,0"(i32 %137) #13, !srcloc !10
...
attributes #6 = { convergent nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="gfx942" "target-features"="+16-bit-insts,+atomic-buffer-global-pk-add-f16-insts,+atomic-ds-pk-add-16-insts,+atomic-fadd-rtn-insts,+atomic-flat-pk-add-16-insts,+atomic-global-pk-add-bf16-inst,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot3-insts,+dot4-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+fp8-conversion-insts,+fp8-insts,+gfx8-insts,+gfx9-insts,+gfx90a-insts,+gfx940-insts,+mai-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize64" "uniform-work-group-size"="true" }
